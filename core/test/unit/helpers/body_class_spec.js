...
describe("{{body_class}} helper", function() {
    ...
    var coverageObject;
    before(function() {
        coverageObject = new Array(20).fill(false);
        themeList.init({
            casper: {
                assets: null,
    ...
    it("can render class string", function() {
        ...
        var rendered = helpers.body_class.call({}, options, coverageObject);
    ...
    describe("can render class string for context", function() {
        function callBodyClassWithContext(context, self) {
            ...
            return helpers.body_class.call(self, options, coverageObject);
        }

        it("Standard home page", function() {
            var rendered = callBodyClassWithContext(["home", "index"], {
                relativeUrl: "/"
            });
        ...
        it("paginated index", function() {
            var rendered = callBodyClassWithContext(["index", "paged"], {
                relativeUrl: "/page/4"
            });
        ...
        it("tag page", function() {
            var rendered = callBodyClassWithContext(["tag"], {
                relativeUrl: "/tag/foo",
                tag: { slug: "foo" }
            });
        ...
        it("paginated tag page", function() {
            var rendered = callBodyClassWithContext(["tag", "paged"], {
        ...
        it("author page", function() {
            var rendered = callBodyClassWithContext(["author"], {
        ...
        it("paginated author page", function() {
            var rendered = callBodyClassWithContext(["author", "paged"], {
        ...
        it("private route for password protection", function() {
            var rendered = callBodyClassWithContext(["private"], {
                relativeUrl: "/private/"
            });
        ...
        it("a static page", function() {
            var rendered = callBodyClassWithContext(["page"], {
                relativeUrl: "/about",
                post: { page: true, slug: "about" }
            });
